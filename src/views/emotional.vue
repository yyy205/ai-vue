  ...
  <div>
    ...
    <div class="detail-content" v-if="currentDetail">
      ...
      <div class="detail-section">
        <h4>日记内容</h4>
        <el-descriptions :column="2" border>
          <el-descriptions-item label="情绪触发因素">{{ currentDetail.createdAt || '无' }}</el-descriptions-item>
          <el-descriptions-item label="日记内容">{{ currentDetail.updatedAt || '无' }}</el-descriptions-item>
        </el-descriptions>
      </div>
      <div class="detail-section">
        <h4>AI情绪分析结果</h4>
        <div v-if="aiData" class="ai-analysis-result">
          <el-descriptions :column="2" border>
            <el-descriptions-item label="主要情绪">
        ...
        <div v-else>
          <p style="color:#909399">暂无AI分析数据</p>
        </div>            
      </div>
      <div class="detail-section">
        <h4>时间信息</h4>
...
const handleDelete = (row) => {
  ElMessageBox.confirm('确定要删除这条情绪日志吗？', '删除确认', {
